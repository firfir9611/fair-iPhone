    ...
    <div class="w-11/12 mx-auto my-4 bg-white rounded-md p-8">
        <div class="mx-auto w-3/4 border p-12 rounded-md">
            <form action="{{ route('manageModelAddSave') }}" method="post" enctype="multipart/form-data">
                ...
                <input class="border rounded-md mt-2 h-4 w-4" type="checkbox" name="show" checked><br>
                {{-- <label for="model">Model Iphone : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Model iPhone" name="model" required> --}}
                <label for="name">Nama Iphone : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Nama iPhone" name="name" required>
                <label for="display">Layar : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Spesifikasi Layar iPhone" name="display" required>
                <label for="os">OS : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Spesifikasi OS iPhone" name="os" required>
                <label for="rearcam">Kamera Belakang : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Spesifikasi Kamera Belakang iPhone" name="rearcam" required>
                <label for="selfie">Kamera Selfie : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Spesifikasi Kamera Selfie iPhone" name="selfie" required>
                <label for="chipset">Chipset : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" placeholder="Masukan Nama iPhone" name="chipset" required>
                <label for="battery">Kapasitas Baterai : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Kapasitas Baterai iPhone" name="battery" required>
                <label for="dimention">Dimensi Ukuran : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="text" placeholder="Masukan Nama iPhone" name="dimention" required>
                <label for="launch_at">Waktu Peluncuran : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" type="date" name="launch_at" required>
                <label for="stok_spare">Stok Cadangan : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" disabled type="number" min="0" name="stok_spare" required>
                <label for="stok_ready">Stok Tersedia : </label><br>
                <input class="p-2 border rounded-md w-full mb-2" disabled type="number" min="0" name="stok_ready" required>
            </form>
